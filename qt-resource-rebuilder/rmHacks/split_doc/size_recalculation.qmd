        ...
        INSERT {
            ...
            function recalcSplitSizes(){
                ...
                ~&5972376&~ (~&7082020628281&~.rmhSplitMode == ~&7082020628281&~.RmhSplittingMode.~&197060196&~) {
                    ...
                    /* rmh(#3): live-bind to parent so a one-shot orientation toggle (which fires recalc mid-rotation with a stale parent.width) doesn't leave the single doc offset; static assignment breaks the binding and the wrong width sticks until another recalc */
                    ~&15793094956877902211&~.~&214646099849&~ = Qt.binding(function() { return ~&15793094956877902211&~.~&7083038346995&~.~&214646099849&~ })
                    ~&15793094956877902211&~.~&7082729686082&~ = Qt.binding(function() { return ~&15793094956877902211&~.~&7083038346995&~.~&7082729686082&~ })
